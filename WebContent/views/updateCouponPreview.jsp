	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<form action="../controller/backAfterUpdate" method=POST>
				...
				coupon id: <input type="text" name="couponid"
					value="<%out.print(((Coupon) obj).get_id());%>"><br>
				business id: <input type="text" name="businessid"
					value="<%out.print(((Coupon) obj).get_busniess_id());%>"><br>
				description: <input type="text" name="description"
					value="<%out.print(((Coupon) obj).get_description());%>"><br>
				<label for="tags">category: </label> <input type="text" id="tags"
					name="category"
					value="<%out.print(((Coupon) obj).get_category());%>"><br>
				price: <input type="text" name="price"
					value="<%out.print(((Coupon) obj).get_price());%>"><br>
				image: <input type="text" name="image"
					value="<%out.print(((Coupon) obj).get_image());%>"><br>
				expire date: <input id="datepicker" name="expiredate"
					value=<%out.print(((Coupon) obj).get_expire_date());%> "/><br>
				time :<input type="text" name="time" value="HH-MM-SS"
					value="<%out.print(((Coupon) obj).get_time());%>"><br>
