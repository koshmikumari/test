...
<script>
	$(function() {
		var availableTags = [ "resterant", "travel", "sport" ];
		$("#tags").autocomplete({
...
<div class="container">
	...
	<form action="../controller/updatecoupon" method="POST">
		<p></p>
...
onblur="if (this.value == '') {this.value = 'First Name';}" /> -->
		...
		description: <input type="text" name="description"><br> <label
			for="tags">category: </label> <input type="text" id="tags"
			name="category"><br> price: <input type="text"
			name="price"><br> image: <input type="text" name="image"><br>
...
onblur="if (this.value == '') {this.value = 'dd-mm-yyyy';}"><br>-->
		expire date: <input id="datepicker" name="expiredate" /><br> time
